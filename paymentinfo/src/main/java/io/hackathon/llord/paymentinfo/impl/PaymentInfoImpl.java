...
public class PaymentInfoImpl {
	...
	public void firstTimeSetup() {
		...
		Payment first = new Payment("Jaime", "Clinton", "40 Magic Road, MAG 1CS", "Amazon FireStick", "Requested",
				"invoice.png", 3499, "GBP", LocalDateTime.now().minusHours(5).minusMinutes(22).toEpochSecond(ZoneOffset.UTC));
		Payment second = new Payment("James", "Butler", "150 Canning Town, E16 1FC", "Plumber payment", "Requested",
				"invoice.png", 62300, "GBP", LocalDateTime.now().minusDays(22).minusHours(12).minusMinutes(3).toEpochSecond(ZoneOffset.UTC));
		Payment third = new Payment("Quynh", "Nhim", "12 Frontside, E12 3FA", "Hair Dryer", "Requested", "invoice.png",
				1299, "GBP", LocalDateTime.now().minusDays(2).minusHours(7).minusMinutes(50).toEpochSecond(ZoneOffset.UTC));
		...
		Payment fifth = new Payment("Jaime", "Clinton", "40 Magic Road, MAG 1CS", "Badminton Lessons", "Paid",
				"invoice.png", 1500, "GBP", LocalDateTime.now().minusDays(32).minusHours(22).minusMinutes(11).toEpochSecond(ZoneOffset.UTC));
		Payment sixth = new Payment("James", "Butler", "12 150 Canning Town, E16 1FC", "Door replacement", "Paid",
				"invoice.png", 12500, "GBP", LocalDateTime.now().minusDays(7).minusHours(3).minusMinutes(11).toEpochSecond(ZoneOffset.UTC));
