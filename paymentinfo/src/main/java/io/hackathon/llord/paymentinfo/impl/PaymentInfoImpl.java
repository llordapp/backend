...
public class PaymentInfoImpl {
	...
	public void firstTimeSetup() {
		...
		Payment first = new Payment("Jaime", "Clinton", "40 Magic Road, MAG 1CS", "Washing Machine", "Requested",
				13299, "GBP", LocalDateTime.now().minusHours(5).minusMinutes(22));
		Payment second = new Payment("James", "Butler", "420 High Street, H14 1EL", "Plumber payment", "Requested",
				62300, "GBP", LocalDateTime.now().minusDays(22).minusHours(12).minusMinutes(3));
		Payment third = new Payment("Quynh", "Nhim", "12 Frontside, E12 3FA", "Hair Dryer", "Requested", 1299, "GBP",
				LocalDateTime.now().minusDays(2).minusHours(7).minusMinutes(50));
		Payment fourth = new Payment("Saci", "Sebo", "12 Frontside, E12 3FA", "TV", "Requested", 97500, "GBP",
